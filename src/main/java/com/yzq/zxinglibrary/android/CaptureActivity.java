...
public final class CaptureActivity extends Activity implements
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if (fromLiveScan) {
            ...
            Log.d(TAG, "handleDecode: rawResult:" + rawResult);
            Log.d(TAG, "handleDecode: rawResult.getText:" + rawResult.getText());
            Log.d(TAG, "handleDecode: barcode:" + barcode);
            saveBitmapFile(barcode);
    ...
    public void saveBitmapFile(Bitmap bitmap){
        String path = Environment.getExternalStorageDirectory() + "/Download/bitmap.jpg";
