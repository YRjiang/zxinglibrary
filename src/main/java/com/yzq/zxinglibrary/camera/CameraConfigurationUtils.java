...
public final class CameraConfigurationUtils {
	...
	private static final int MIN_PREVIEW_PIXELS = 240 * 160; // normal screen  480 * 320
	private static final float MAX_EXPOSURE_COMPENSATION = 1.5f;
	private static final float MIN_EXPOSURE_COMPENSATION = 0.0f;//曝光补偿
	private static final double MAX_ASPECT_DISTORTION = 0.15;//方位畸形
